          ...
          <div className="w-full lg:w-[45%] flex justify-center">
            <div className="relative w-full aspect-[4/3] max-w-[600px] bg-white">
                <Image 
                  ...
                  alt="JR-Interieur kantoorinrichting ontwerp"
                fill
          ...
          <div className="w-full lg:w-[55%]">
            <div className="max-w-[700px]">
              <h2 className="text-[28px] md:text-[48px] font-light leading-[1.1] mb-8 flex items-baseline flex-wrap">
                <span className="text-black tracking-widest mr-3">DESIGN</span>
                <span className="text-black font-bold tracking-widest">& BUILD</span>
              </h2>
              
              <div className="space-y-6 text-[#555555] text-[16px] leading-[1.6]">
                <p>
                  Bij JR-Interieur krijgt u een complete kantoorinrichting, waarbij wij u begeleiden vanaf het eerste ontwerp tot en met de oplevering van het laatste detail. In elke projectgroep werken specialisten met kennis over interieur, bouw, installaties en ergonomie.
                </p>
                <p>
                  Van advies en 3D-ontwerp tot installatie door onze eigen monteurs. Wij leveren en installeren door heel Nederland en België, met gratis bezorging en montage inbegrepen.
                </p>
              </div>
