        ...
        <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-20">
          ...
          <div className="w-full lg:w-1/2 text-center lg:text-left">
            ...
            <h2 className="text-[36px] md:text-[52px] lg:text-[64px] font-light uppercase leading-[1.05] tracking-[0.02em] text-white mb-6">
              Klaar voor een
              <br />
              <span className="font-bold">nieuw kantoor?</span>
            </h2>
            
            <p className="text-[16px] md:text-[18px] leading-[1.7] text-white/60 max-w-[480px] mx-auto lg:mx-0 mb-10">
              Laat ons u inspireren met een persoonlijk adviesgesprek. 
              Wij denken graag met u mee over de ideale werkplekinrichting.
            </p>
          ...
          <div className="w-full lg:w-1/2 relative">
            <div className="relative aspect-[4/3] overflow-hidden">
              ...
              <Image
                ...
                alt="Modern kantoorinterieur door JR-Interieur"
                fill
